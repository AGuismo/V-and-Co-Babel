...
QT_MOC_LITERAL(3, 11, 16),
QT_MOC_LITERAL(4, 28, 16),
QT_MOC_LITERAL(5, 45, 11),
QT_MOC_LITERAL(6, 57, 3)
    },
    "Audio\0run\0\0handleOutputRead\0"
    "handleInputWrite\0std::string\0str\0"
};
...
void Audio::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->run(); break;
        case 1: _t->handleOutputRead(); break;
        case 2: _t->handleInputWrite((*reinterpret_cast< const std::string(*)>(_a[1]))); break;
        default: ;
        }
    }
}
