...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_AddFriendWindow_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 73, 21)
    ...
    "AddFriendWindow\0add_try\0\0std::string\0"
    "friendLogin\0on_close_button_clicked\0"
...
void AddFriendWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        AddFriendWindow *_t = static_cast<AddFriendWindow *>(_o);
        switch (_id) {
        case 0: _t->add_try((*reinterpret_cast< const std::string(*)>(_a[1]))); break;
        ...
        {
            typedef void (AddFriendWindow::*_t)(const std::string & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AddFriendWindow::add_try)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject AddFriendWindow::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_AddFriendWindow.data,
      qt_meta_data_AddFriendWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AddFriendWindow.stringdata))
        return static_cast<void*>(const_cast< AddFriendWindow*>(this));
...
// SIGNAL 0
void AddFriendWindow::add_try(const std::string & _t1)
{
