...
struct qt_meta_stringdata_TCPNetwork_t {
    QByteArrayData data[4];
    char stringdata[34];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_TCPNetwork_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_TCPNetwork_t qt_meta_stringdata_TCPNetwork = {
    {
...
QT_MOC_LITERAL(3, 19, 13)
    ...
    "TCPNetwork\0onRead\0\0on_disconnect\0"
};
...
const QMetaObject TCPNetwork::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TCPNetwork.data,
      qt_meta_data_TCPNetwork,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TCPNetwork.stringdata))
        return static_cast<void*>(const_cast< TCPNetwork*>(this));
    if (!strcmp(_clname, "ANetwork"))
        return static_cast< ANetwork*>(const_cast< TCPNetwork*>(this));
