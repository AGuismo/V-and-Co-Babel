...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ConnectWindow_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 73, 23),
QT_MOC_LITERAL(8, 97, 25)
    },
    "ConnectWindow\0connect_try\0\0std::string\0"
    "ipAddress\0unsigned short int\0port\0"
...
void ConnectWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->connect_try((*reinterpret_cast< const std::string(*)>(_a[1])),(*reinterpret_cast< unsigned short int(*)>(_a[2]))); break;
        ...
        {
            typedef void (ConnectWindow::*_t)(const std::string & , unsigned short int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ConnectWindow::connect_try)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject ConnectWindow::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ConnectWindow.data,
      qt_meta_data_ConnectWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ConnectWindow.stringdata))
...
// SIGNAL 0
void ConnectWindow::connect_try(const std::string & _t1, unsigned short int _t2)
{
