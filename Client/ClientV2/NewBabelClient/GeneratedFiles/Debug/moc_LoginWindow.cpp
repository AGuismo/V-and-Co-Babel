...
QT_MOC_LITERAL(8, 87, 23)
    ...
    "login\0std::string&\0password\0"
    "on_close_button_clicked\0on_login_button_clicked\0"
};
...
void LoginWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->login_try((*reinterpret_cast< const std::string(*)>(_a[1])),(*reinterpret_cast< std::string(*)>(_a[2]))); break;
        ...
        {
            typedef void (LoginWindow::*_t)(const std::string & , std::string & );
...
// SIGNAL 0
void LoginWindow::login_try(const std::string & _t1, std::string & _t2)
{
