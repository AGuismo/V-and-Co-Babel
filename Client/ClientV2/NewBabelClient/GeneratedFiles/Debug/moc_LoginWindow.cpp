...
QT_MOC_LITERAL(7, 74, 23)
    },
    "LoginWindow\0login_try\0\0std::string\0"
    "login\0password\0on_close_button_clicked\0"
...
void LoginWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->login_try((*reinterpret_cast< const std::string(*)>(_a[1])),(*reinterpret_cast< const std::string(*)>(_a[2]))); break;
        ...
        {
            typedef void (LoginWindow::*_t)(const std::string & , const std::string & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LoginWindow::login_try)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void LoginWindow::login_try(const std::string & _t1, const std::string & _t2)
{
