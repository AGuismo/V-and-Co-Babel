...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_FriendListWidget_t, stringdata) + ofs \
...
const QMetaObject FriendListWidget::staticMetaObject = {
    { &QListWidget::staticMetaObject, qt_meta_stringdata_FriendListWidget.data,
      qt_meta_data_FriendListWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FriendListWidget.stringdata))
