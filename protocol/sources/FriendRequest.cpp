...
namespace	request
{
  ...
  namespace	server
  {
    ...
    Update::Update(const request::Status st,
      ...
      Friend(server::friends::UPDATE), status(st), detail(detail), username(username)
    {
    }
    ...
    Update::Update(const Update &src) :
      Friend(server::friends::UPDATE), status(src.status), detail(src.detail), username(src.username)
    {
  ...
  {
    Request::Request():
      Friend(client::friends::REQUEST)
    {
    }

    Request::Request(const request::Username &from,
		   const request::Username &to):
      Friend(client::friends::REQUEST), from(from), to(to)
    {
    }
    ...
    Request::Request(const Request &src) :
      Friend(client::friends::REQUEST), from(src.from), to(src.to)
    {
    ...
    DelFriend::DelFriend():
      Friend(client::friends::DEL_FRIEND)
    {
    }

    DelFriend::DelFriend(const request::Username &from):
      Friend(client::friends::DEL_FRIEND), from(from)
    {
    }
    ...
    DelFriend::DelFriend(const DelFriend &src) :
      Friend(client::friends::DEL_FRIEND), from(src.from)
    {
      ...
      if (this != &src)
	{
      ...
      ARequest	*DelFriend::clone()
    {
      return (new DelFriend());
    }
    ...
    Accept::Accept():
      Friend(client::friends::ACCEPT)
    {
    }

    Accept::Accept(const request::Username &from,
		   const request::Username &to):
      Friend(client::friends::ACCEPT), from(from), to(to)
    {
    }
    ...
    Accept::Accept(const Accept &src) :
      Friend(client::friends::ACCEPT), from(src.from), to(src.to)
    {
    ...
    Refuse::Refuse():
      Friend(client::friends::REFUSE)
    {
    }

    Refuse::Refuse(const request::Username &from,
		   const request::Username &to):
      Friend(client::friends::REFUSE), from(from), to(to)
    {
    }
    ...
    Refuse::Refuse(const Refuse &src) :
      Friend(client::friends::REFUSE), from(src.from), to(src.to)
    {
